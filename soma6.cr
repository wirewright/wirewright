...
class Document
  ...
  private def below?(x : Term::Num, y : Term::Num) : Array(Int32)?
    ...
    stratum.leftmost? do |keypath|
      ...
      nodepath = Array(Int32).new(backlink.size)
  ...
  private def mark(& : Array(Int32), Term -> Term) : Nil
    nodepath = [] of Int32
  ...
  private def hover(nodepath : Array(Int32), node : Term, mouseover : Array(Int32)?) : Term
