module Ww::Scenery
  ...
  private def box!(cache, node : Content | Floating | Limit | ZStack | Composite | TransformMatrix | Viewport | Aim | Page | Overlay | Observer | Observable | Gate, size : Size) : OriginBox
    child_boxes = Pf::Kit.stack_array(Box, 8)
