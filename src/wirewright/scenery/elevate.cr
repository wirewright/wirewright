module Ww::Scenery
  ...
  private def elevate!(cache, node : Content | Floating | Limit | Padding | Align | XYStack | ZStack | Composite | TransformMatrix | Viewport | Aim | Observer | Observable | Gate, box : OriginBox) : ElevateResponse
